...
public class ADClicksCollector implements Collector<ADViewWithClick, ADStatistic, ADStatistic> {
...
//    }
    ...
    @Override
    public synchronized BiConsumer<ADStatistic, ADViewWithClick> accumulator() {
        return (stat, view) -> {
    ...
    public static synchronized ADClicksCollector clicksCollector() {
        return new ADClicksCollector();
    }
}
